...
var emailsgin = document.querySelector(".email-sign");
...
function check() {
  for (var i = 0; i < allarry.length; i++) {
    if (
      allarry[i].email.toLowerCase() === emailsgin.value.toLowerCase() &&
      allarry[i].pass.toLowerCase() === passsgin.value.toLowerCase()
    ) {
...
const url =
  "https://api.weatherapi.com/v1/current.json?key=3b4dfcf6e8d44f3f879125222230108&q=egypt";
